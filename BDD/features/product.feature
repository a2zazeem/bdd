Feature: Opencart Application TC02
  Scenario: Product Comparison
    ...
    And I passed "mohammad.khan58@wipro.com" Login
    ...
    And I passed "Mohammad Azeem" first name in the Billing Details
    And I passed "Khan" second name in the billing Details
